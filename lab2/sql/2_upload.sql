create or replace procedure insert_data(file text)
    LANGUAGE plpgsql
AS
$$
BEGIN
...
CALl insert_data('/data/MOCK_DATA.csv');
CALl insert_data('/data/MOCK_DATA (1).csv');
CALl insert_data('/data/MOCK_DATA (2).csv');
CALl insert_data('/data/MOCK_DATA (3).csv');
CALl insert_data('/data/MOCK_DATA (4).csv');
CALl insert_data('/data/MOCK_DATA (5).csv');
CALl insert_data('/data/MOCK_DATA (6).csv');
CALl insert_data('/data/MOCK_DATA (7).csv');
CALl insert_data('/data/MOCK_DATA (8).csv');
CALl insert_data('/data/MOCK_DATA (9).csv');